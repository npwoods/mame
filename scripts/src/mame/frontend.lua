...
files {
	...
	MAME_DIR .. "src/frontend/mame/ui/menubar.cpp",
	MAME_DIR .. "src/frontend/mame/ui/menubar.h",
	MAME_DIR .. "src/frontend/mame/ui/mame_menubar.cpp",
	MAME_DIR .. "src/frontend/mame/ui/mame_menubar.h",
