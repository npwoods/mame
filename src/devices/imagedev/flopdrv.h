...
public:
	...
	virtual bool call_create(const image_device_format *create_format, util::option_resolution *format_options) override;
...
private:
	...
	int internal_floppy_device_load(bool is_create, const image_device_format *create_format, util::option_resolution *create_args);
