...
const util::rom_entry *c1540_t::device_rom_region() const
{
...
const util::rom_entry *c1541_t::device_rom_region() const
{
...
const util::rom_entry *c1541c_t::device_rom_region() const
{
...
const util::rom_entry *c1541ii_t::device_rom_region() const
{
...
const util::rom_entry *sx1541_t::device_rom_region() const
{
...
const util::rom_entry *fsd1_t::device_rom_region() const
{
...
const util::rom_entry *fsd2_t::device_rom_region() const
{
...
const util::rom_entry *csd1_t::device_rom_region() const
{
...
const util::rom_entry *c1541_dolphin_dos_t::device_rom_region() const
{
...
const util::rom_entry *c1541_professional_dos_v1_t::device_rom_region() const
{
...
const util::rom_entry *c1541_prologic_dos_classic_t::device_rom_region() const
{
...
const util::rom_entry *indus_gt_t::device_rom_region() const
{
