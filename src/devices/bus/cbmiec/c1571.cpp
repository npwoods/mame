...
const util::rom_entry *c1570_t::device_rom_region() const
{
...
const util::rom_entry *c1571_t::device_rom_region() const
{
...
const util::rom_entry *c1571cr_t::device_rom_region() const
{
...
const util::rom_entry *mini_chief_t::device_rom_region() const
{
