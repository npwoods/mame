...
const util::rom_entry *c2040_t::device_rom_region() const
{
...
const util::rom_entry *c3040_t::device_rom_region() const
{
...
const util::rom_entry *c4040_t::device_rom_region() const
{
