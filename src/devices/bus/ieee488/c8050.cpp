...
const util::rom_entry *c8050_t::device_rom_region() const
{
...
const util::rom_entry *c8250lp_t::device_rom_region() const
{
...
const util::rom_entry *sfd1001_t::device_rom_region() const
{
