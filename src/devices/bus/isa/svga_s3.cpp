...
const util::rom_entry *isa16_svga_s3_device::device_rom_region() const
{
...
const util::rom_entry *isa16_s3virge_device::device_rom_region() const
{
...
const util::rom_entry *isa16_s3virgedx_device::device_rom_region() const
{
...
const util::rom_entry *isa16_stealth3d2kpro_device::device_rom_region() const
{
