...
const util::rom_entry *isa8_cga_device::device_rom_region() const
{
	return ROM_NAME( cga );
}
...
const util::rom_entry *isa8_cga_poisk2_device::device_rom_region() const
{
...
const util::rom_entry *isa8_cga_pc1512_device::device_rom_region() const
{
	return nullptr;
}
...
const util::rom_entry *isa8_wyse700_device::device_rom_region() const
{
...
const util::rom_entry *isa8_cga_iskr1031_device::device_rom_region() const
{
...
const util::rom_entry *isa8_cga_iskr1030m_device::device_rom_region() const
{
...
const util::rom_entry *isa8_cga_mc1502_device::device_rom_region() const
{
