...
const util::rom_entry *dmv_k230_device::device_rom_region() const
{
	return ROM_NAME( dmv_k230 );
}

const util::rom_entry *dmv_k231_device::device_rom_region() const
{
	return ROM_NAME( dmv_k231 );
}

const util::rom_entry *dmv_k234_device::device_rom_region() const
{
	return nullptr;
}

const util::rom_entry *dmv_k235_device::device_rom_region() const
{
