...
const util::rom_entry *action_replay_mk1_device::device_rom_region() const
{
...
const util::rom_entry *action_replay_mk2_device::device_rom_region() const
{
...
const util::rom_entry *action_replay_mk3_device::device_rom_region() const
{
