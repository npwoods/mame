...
const util::rom_entry *saa5050_device::device_rom_region() const
{
	return ROM_NAME( saa5050 );
}

const util::rom_entry *saa5051_device::device_rom_region() const
{
	return ROM_NAME( saa5051 );
}

const util::rom_entry *saa5052_device::device_rom_region() const
{
	return ROM_NAME( saa5052 );
}

const util::rom_entry *saa5053_device::device_rom_region() const
{
	return ROM_NAME( saa5053 );
}

const util::rom_entry *saa5054_device::device_rom_region() const
{
	return ROM_NAME( saa5054 );
}

const util::rom_entry *saa5055_device::device_rom_region() const
{
	return ROM_NAME( saa5055 );
}

const util::rom_entry *saa5056_device::device_rom_region() const
{
	return ROM_NAME( saa5056 );
}

const util::rom_entry *saa5057_device::device_rom_region() const
{
