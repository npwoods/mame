...
const util::rom_entry *namco_c69_device::device_rom_region() const
{
	return ROM_NAME(c69);
}

const util::rom_entry *namco_c70_device::device_rom_region() const
{
	return ROM_NAME(c70);
}

const util::rom_entry *namco_c74_device::device_rom_region() const
{
	return ROM_NAME(c74);
}

const util::rom_entry *namco_c75_device::device_rom_region() const
{
	return ROM_NAME(c75);
}

const util::rom_entry *namco_c76_device::device_rom_region() const
{
	return ROM_NAME(c76);
}
