...
inline void construct_core_types_UI(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FRAMESKIP_DEC,    "Frameskip Dec",          input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FRAMESKIP_INC,    "Frameskip Inc",          input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_THROTTLE_DEC,     "Throttle Dec",           input_seq(KEYCODE_F8) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_THROTTLE_INC,     "Throttle Inc",           input_seq(KEYCODE_F9) )
