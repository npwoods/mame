...
public:
	...
	virtual image_init_result call_create(const image_device_format *create_format, util::option_resolution *format_options) { return image_init_result::PASS; }
...
protected:
	...
	image_init_result load_internal(const std::string &path, bool is_create, const image_device_format *create_format, util::option_resolution *create_args);
